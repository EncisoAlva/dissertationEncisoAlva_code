...
% protocol of my own design:
%  > 1 constrained dipole patch at brain cortex.
%  > Dipole 'shape' is given as
%        ||J_r||_2 = F(|r_*-r|)
%    with r in R^3 and r_* the 'center' of the patch.
%  > 1 timepoint (timescale is irrelevant then).
%  > Added noise on sensors with prescribed SNR (given)
%
% Author: Julio C Enciso-Alva (2025)
%         juliocesar.encisoalva@mavs.uta.edu
%
function RES = Protocol04_2( meta, result, info )
